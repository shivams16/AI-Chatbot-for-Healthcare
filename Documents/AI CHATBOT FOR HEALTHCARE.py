...
training_dataset = pd.read_csv(r'E:\Chatbot\Training.csv')
test_dataset = pd.read_csv(r'E:\Chatbot\Testing.csv')
...
doc_dataset = pd.read_csv(r'E:\Chatbot\doctors_dataset.csv', names=['Name', 'Description'])
